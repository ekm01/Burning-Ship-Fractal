...
typedef struct bmpHeader_p //BMP file format from wikipedia: "https://en.wikipedia.org/wiki/BMP_file_format" //bmpHeader has the size of 54 bytes
{
...
typedef struct bmpImage_p //our bmp image has a bmp header and a pixel array
{
    struct bmpHeader_p header;
